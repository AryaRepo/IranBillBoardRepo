...
public class MiladiToShamsi implements Serializable
{

    //****************************************************************//
    // public Static Variables
    //****************************************************************//
    private static int g_days_in_month[] = { 31, 28, 31, 30, 31, 30, 31, 31, 30,
            31, 30, 31 };
    private static int j_days_in_month[] = { 31, 31, 31, 31, 31, 31, 30, 30, 30,
            30, 30, 29 };
    private static final int SATARDAY = 1;
    private static final int SUNDAY = 2;
    private static final int MONDAY = 3;
    private static final int TUESDAY = 4;
    private static final int WENDSDAY = 5;
    ...
    public static Calendar getGregorianCalendar(MiladiToShamsi jalali){
     ...
     * Constructor
     * */
    public MiladiToShamsi(Calendar gregorian) {
     ...
     * */
    public MiladiToShamsi(String jalaliString){
    ...
    public MiladiToShamsi(MiladiToShamsi jalali){
        setPersainCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public MiladiToShamsi(int jalaliyear, int jalalimonth, int jalaliday){
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public MiladiToShamsi(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    public boolean isEqual(MiladiToShamsi jalali){
    ...
    public int compareTo(MiladiToShamsi jalali){
